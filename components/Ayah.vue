<template>
  <div class="ayat-list md:mt-6 dark:text-gray-400" v-if="ayah">
    <div
    ...
    >
      ...
      <nuxt-link
        ...
        :to="{ name: 'surah-number', params: { number: ayah.surahNumber }, hash: `#ayah-${ayah.number}` }"
        >Countinue Reading</nuxt-link>
    </div>
  </div>
</template>
